...
from datasets import make_dataloader, make_replay_dataloader, getDatasetClassNum, select_replay_samples
...
if __name__ == '__main__':
    ...
    old_replay_dataset_path = os.path.join(cfg.SOLVER.REPLAY_DATASET_PATH, 'old_replay_data_phase{}.pth'.format(cfg.SOLVER.TRAINING_PHASE-1))
    if(cfg.SOLVER.TRAINING_PHASE == 2):
        ...
        if(os.path.exists(old_replay_dataset_path)):
