...
python test.py --config_file configs/Test/vit_transreid_cl_step1.yml MODEL.DIST_TRAIN False MODEL.DEVICE_ID "('0')" DATASETS.NAMES "('msmt17')"

python test.py --config_file configs/Test/vit_transreid_res50_cl_step2_SimLoss_epoch0.yml MODEL.DIST_TRAIN False MODEL.DEVICE_ID "('0')"
